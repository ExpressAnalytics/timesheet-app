    ...
    def get_all_open_epics(self) -> list:
        ...
        try:
            ...
            fields = ["summary", "status", "assignee", "customfield_10020",
                      "customfield_10016", "customfield_10026", "customfield_10028", "customfield_10008"]  # story points variants
            ...
            for issue in issues:
                ...
                if isinstance(sprints, list) and sprints:
                    sprint_name = sprints[-1].get("name")
                sp = (f.get("customfield_10016") or f.get("customfield_10026")
                      or f.get("customfield_10028") or f.get("customfield_10008"))
                epics.append({
                    "key":          issue["key"],
                    "name":         f.get("summary", ""),
